...
func firebaseOption() (option.ClientOption, error) {
	...
	return nil, fmt.Errorf("set FIREBASE_CREDENTIALS_FILE or FIREBASE_CREDENTIALS_JSON")
}
...
func allowedOrigins() []string {
	...
	if rawOrigins == "" {
		return []string{"http://localhost:3000", "https://pushkarm029.github.io"}
	}
...
func main() {
	...
	opt, err := firebaseOption()
	if err != nil {
		log.Fatalf("Error loading Firebase credentials: %v\n", err)
	}
